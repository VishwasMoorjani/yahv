...
function myFunction() {
  // Get the text field
  var copyText = document.getElementById("refer-input");
...
// var otp=document.getElementById("send-otp")
// otp.addEventListener("click",()=>{
//   console.log("click")
//   documentElement.getElementById("otp").style.display="block";
//   documentElement.getElementById("verify").style.display="block";
//   document.getElementById("change-email").readOnly = true;
// })
